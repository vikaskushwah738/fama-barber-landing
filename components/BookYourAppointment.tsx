        ...
        <section className="bg-[#1A1A1A] py-24 lg:px-16 md:px-10 px-5 relative overflow-hidden" id='contact'>
            ...
            <div className="flex justify-center items-center flex-col z-10">
                ...
                <h2 className="md:text-4xl text-3xl text-white font-bold pt-4 group relative inline-block z-10">
                    <span className=" pb-1 text-white relative after:content-[''] after:absolute after:bottom-0 after:left-12 after:w-20 after:h-[3px] after:bg-[#DEAE34] after:transition-all after:duration-300 group-hover:after:left-0 group-hover:after:w-full">
                        Contact Us
                    </span>
                </h2>
