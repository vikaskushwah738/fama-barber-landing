...
const PremiumGrooming = () => {
    return (
        <section className="bg-[#1A1A1A] py-10 lg:px-16 md:px-10 px-5 relative overflow-hidden">
            <div
            ...
            <div className="pt-10 gap-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  text-white">
                <div className="bg-[#222222] h-[450px] rounded-xl border-1 border-[#71717B] lg:px-6 px-5 ">
                    <div className="w-[79px] h-[79px] flex justify-center items-center pt-16">
                        <div className=" relative bg-[#2D2D2D] p-2 rounded-xl">
                            <Image
                    ...
                    <h4 className="pt-14">Haircuts</h4>
